...
public class AutomaticLittleProduct {
...
//		caps.setCapability("os_version", "9.0");
	...
	public void buyProduct() throws Throwable {
		...
		WebElement subMenuLitterRobot = driver.findElement(By.xpath("//a[contains(text(),'Automatic Self Cleaning Litter-Robot')]"));
		subMenuLitterRobot.click();
		System.out.println("We have clicked on Automatic Litter-Robot Connect First sub menu");
...
*/
		...
		WebElement buyNowBtn = driver.findElement(By.id("catbuy"));
